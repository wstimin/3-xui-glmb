...
PORT="${PORT:-3388}"
DEFAULT_REPO_URL="${DEFAULT_REPO_URL:-https://github.com/wstimin/3-xui-glmb.git}"
DEFAULT_PACKAGE_URL="${DEFAULT_PACKAGE_URL:-https://github.com/wstimin/3-xui-glmb/releases/latest/download/shiye-3xuigl.zip}"
PACKAGE_URL="${PACKAGE_URL:-${DEFAULT_PACKAGE_URL}}"
INSTALL_SOURCE="${INSTALL_SOURCE:-auto}"
INSTALL_URL="${INSTALL_URL:-https://raw.githubusercontent.com/wstimin/3-xui-glmb/main/install.sh}"
UNINSTALL_URL="${UNINSTALL_URL:-https://raw.githubusercontent.com/wstimin/3-xui-glmb/main/uninstall.sh}"
